...
class BindTableCell: UITableViewCell {
    //图片
    ...
    fileprivate func InitUI(){
        ...
        titleLabel.textColor = YCColorTitleBlack
        ...
        descriLable.textColor = YCColorTitleBlack
    ...
    internal func gaintDic(dic:NSDictionary) {
        headImage.image = UIImage(named: (dic["image"] as? String)!)
        titleLabel.text = dic["title"] as? String
        descriLable.text = dic["content"] as? String
    }
