...
class InvalidOrderController: BaseController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let invalidCell = tableView.dequeueReusableCell(withIdentifier:WaitPayCellIdentifier) as! WaitPayCell
        invalidCell.ModifyInvalidCellsStyle()
        return invalidCell
    }
