...
let NORMAL_BASE_COLOR: UIColor = gof_RGBAColor(220,234,255,1)
...
public class LTLayout: NSObject {
    ...
    /* pageView背景颜色 */
    @objc public var titleViewBgColor: UIColor? = YCBackground_LightColor
    ...
    /* 标题字号 */
    @objc public var titleFont: UIFont? = YC_FONT_PFSC_Semibold(16)
    ...
    /* 滑块底部线圆角 */
    @objc public var bottomLineCornerRadius: CGFloat = 2.0
    
    /* 是否隐藏滑块、底部线*/
    @objc public var isHiddenSlider: Bool = false
    
    /* 标题直接的间隔（标题距离下一个标题的间隔）*/
    @objc public var titleMargin: CGFloat = 18.0
    
    /* 距离最左边和最右边的距离 */
    @objc public var lrMargin: CGFloat = 24.0
