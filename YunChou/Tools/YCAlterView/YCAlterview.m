...
#import "YCAlterview.h"
#import "UILabel+ContentSize.h"
#import "NSString+TxtHeight.h"
#import "ObjectAppMacro.h"

/*! 设置警告框的长和宽 */
#define Alertwidth Main_Screen_Width*0.8
...
+(YCAlterview*)showmessage:(NSString *)message subtitle:(NSString *)subtitle cancelbutton:(NSString *)cancle
{
    
    YCAlterview *alert = [[YCAlterview alloc] initWithTitle:message contentText:subtitle rightButtonTitle:nil leftButtonTitle:cancle];
    [alert show];
    alert.rightBlock = ^() {
    };
    alert.dismissBlock = ^() {
