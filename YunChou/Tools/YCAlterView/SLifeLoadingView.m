...
#import "SLifeLoadingView.h"
#import "ObjectAppMacro.h"

static SLifeLoadingView *activiyView;

@interface SLifeLoadingView ()
...
@implementation SLifeLoadingView
+ (void)show {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        if (activiyView == nil) {
            CGRect rect = [UIScreen mainScreen].bounds;
            activiyView = [[SLifeLoadingView alloc] initWithFrame:rect];
