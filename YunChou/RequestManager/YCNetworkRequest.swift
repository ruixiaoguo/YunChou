...
private let NetworkRequestShareInstance = YCNetworkRequest()

#if DEBUG
let BYBASEURL = "http://api.liwushuo.com/v2/channels/104/items?"
#else
let BYBASEURL = "http://api.liwushuo.com/v2/channels/104/items?"
#endif

class YCNetworkRequest: NSObject {
    class var sharedInstance : YCNetworkRequest {
