...
class RefundMoneyController: BaseController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let refundCell = tableView.dequeueReusableCell(withIdentifier:WaitPayCellIdentifier) as! WaitPayCell
        refundCell.ModifyRefundCellsStyle()
        return refundCell
    }
